            ...
            <div className="">
              ...
              <div className="">
                <button
                  ...
                  className="w-[10rem] py-4 px-10 mt-5 rounded-lg text-lg font-bold text-white hover:bg-green-900 bg-green-600 mr-6"
                >
                  Update
                </button>
                <button
                  onClick={handleDelete}
                  className="w-[10rem] py-4 px-10 mt-5 rounded-lg text-lg font-bold text-white hover:bg-pink-900  bg-pink-600"
                >
                  Delete
                </button>
              </div>
